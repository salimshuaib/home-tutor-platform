...
import { Users, Mail, Clock as ClockIcon } from 'lucide-react';
import { safeText } from '../../../utils/safeText';
import { formatDate } from './AdminOverview';

export default function ApprovedTutors() {
  ...
  return (
    <>
      <div className="page-header"><h1 className="page-title">Approved <em>Tutors</em></h1></div>
      {tutors.length === 0 ? (
        <div className="empty-state"><Users size={48} style={{ color: 'var(--gold-light)', opacity: .6 }} /><h3>No approved tutors yet</h3><p>Approve pending tutors to see them here.</p></div>
      ) : (
